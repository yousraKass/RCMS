...
void PrizeWinners::CalculateMonthlyPrizeWinner(Restaurant *root, int month, int year, Restaurant *&IdA, float &winnerA, Restaurant *&IdS, float &winnerS, Restaurant *&IdI, float &winnerI, Restaurant *&IdE, float &winnerE, Restaurant *&IdC, float &winnerC)
{
    if (root == nullptr)
        return;
...
PrizeWinners::PrizeWinners(const BSTRestaurantTree &rcms, const Date &firstDate)
{
...
vector<Restaurant *> PrizeWinners::getWinners(int month, int year)
{
...
PrizeWinners::PrizeWinners(const AVLRestaurantTree &rcms, const Date &firstDate)
{
    FirstCreationDate = firstDate;
...
vector<vector<Restaurant *>> PrizeWinners::getWinners(int startMonth, int startYear, int endMonth, int endYear)
{
